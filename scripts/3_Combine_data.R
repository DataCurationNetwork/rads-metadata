...
write.csv(all_dois_by_IRpublisher, file="data_all_dois/All_IR_dois_20221114.csv", row.names = F)
...
rm(list = ls()[-which(ls() == "all_dois_by_IRpublisher")])
...
all_dois_by_AffiliationDC <- all_dois %>% 
...
combined_dois <- bind_rows(all_dois_by_AffiliationDC, all_dois_by_AffiliationCR, all_dois_by_IRpublisher)
