...
#read in IR data
irdat <- read.csv("data_all_dois/All_IR_dois_20220727.csv")
doidat <- read.csv("data_all_dois/All_dois_20220624.csv")
...
ggsave(freescale_bar, 
       filename = "figures/Counts of Data DOIs by Insitution and IR.png", 
       device = "png", 
       height = 7, 
       width = 10)
...
ggsave(collapseir, 
       filename = "figures/Counts of Data DOIs by Insitution and Combined IR.png", 
       device = "png", 
       height = 7, 
       width = 12)
...
#remove Morphosource as an IR pub
irpubs <- irpubs[-which(irpubs == "Duke-MorphoSource Media")]
...
ggsave(collapseallir, 
       filename = "figures/Counts of Data DOIs by Insitution and IRs_singlebar_Morphosource_removed.png", 
       device = "png", 
       height = 7, 
       width = 12)
